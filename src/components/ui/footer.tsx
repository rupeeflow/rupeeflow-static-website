    ...
    <footer className="w-full bg-[#0c1a13] text-gray-300">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-14 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-[2fr_1.1fr_1.1fr_1.1fr_1.1fr] gap-x-8 gap-y-10 border-b border-white/[0.06]">
        ...
        <div className="col-span-2 md:col-span-1">
          ...
          <div className="mt-2">
            <a
              href="/E-copy-RUPEEFLOW%20FINANCE%20PRIVATE%20LIMITED-ISMS-CA.pdf"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Open ISO 27001 certificate"
            ...
            >
              <Image
                ...
                width={96}
                height={96}
                className="object-contain rounded-md border border-white/10 hover:opacity-90 transition-opacity duration-150"
              />
            </a>
          </div>
        </div>
