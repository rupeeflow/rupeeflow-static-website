...
const BuiltForSection = () => {
  return (
    <div className="flex w-full py-20 flex-col bg-[var(--background)] items-center justify-center relative">
      <h1 className="text-3xl  lg:text-5xl fontheadingthin text-[var(--foreground)] text-center ml-4 sm:ml-8 lg:ml-12 mb-2">
