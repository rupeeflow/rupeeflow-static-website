...
const jobs: Job[] = [
  {
    ...
    description:
      'Join our core engineering team to build scalable payment infrastructure that processes millions of transactions daily.',
    responsibilities: [
  ...
  },
  {
    ...
    description:
      'Build beautiful, responsive user interfaces that make complex financial operations simple and intuitive.',
    responsibilities: [
  ...
  },
  {
    ...
    description:
      'Drive product strategy and execution for our payment solutions, working at the intersection of technology and finance.',
    responsibilities: [
  ...
  },
  {
    ...
    experience: '3-5 years',
    description:
      'Build and maintain our cloud infrastructure ensuring 99.99% uptime for critical financial services.',
    responsibilities: [
  ...
  },
  {
    ...
    experience: '4-6 years',
    description:
      'Ensure RupeeFlow meets all regulatory requirements and maintains the highest standards of compliance.',
    responsibilities: [
...
const benefits: Benefit[] = [
  {
    ...
    description:
      'Industry-leading salary packages with performance bonuses and equity options for senior roles.',
  },
  {
    icon: <Heart className="w-6 h-6" />,
    title: 'Health & Wellness',
    description:
      'Comprehensive health insurance for you and family, mental health support, and wellness programs.',
  },
  {
    icon: <Clock className="w-6 h-6" />,
    title: 'Flexible Working',
    description:
      'Remote-friendly culture with flexible hours. Work from home or our modern Bangalore office.',
  },
  {
    icon: <TrendingUp className="w-6 h-6" />,
    title: 'Learning & Growth',
    description:
      'Unlimited learning budget, conference sponsorships, and mentorship programs for career development.',
  },
  {
    icon: <Users className="w-6 h-6" />,
    title: 'Team Events',
    description:
      'Regular team outings, hackathons, and celebrations. Build lasting friendships with amazing people.',
  },
  {
    icon: <Award className="w-6 h-6" />,
    title: 'Performance Rewards',
    description:
      'Quarterly bonuses, spot awards, and recognition programs. Your contributions truly matter.',
  },
]
...
const cultureValues: CultureValue[] = [
  {
    ...
    title: 'Move Fast',
    description:
      'We ship quickly and iterate. Speed is a feature in fintech. We value velocity without compromising quality.',
  },
  {
    icon: <Shield className="w-8 h-8" />,
    title: 'Security First',
    description:
      'Trust is our foundation. We build secure systems, follow best practices, and never compromise on safety.',
  },
  {
    icon: <Users className="w-8 h-8" />,
    title: 'Customer Obsessed',
    description:
      'Every decision starts with the customer. We build products that solve real problems and delight users.',
  },
  {
    icon: <TrendingUp className="w-8 h-8" />,
    title: 'Own Your Impact',
    description:
      'We empower you to take ownership. Make decisions, drive projects, and see your work make a difference.',
  },
]
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        >
          <motion.div variants={item} className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto fontbody">
              At RupeeFlow, we&apos;re building more than just technology –
              we&apos;re creating a movement to democratize financial services
              in India.
            </p>
          </motion.div>
            ...
            {cultureValues.map((value, idx) => (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-400 fontbody2 leading-relaxed">
                    {value.description}
                  </p>
                </div>
              </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {benefits.map(benefit => (
              ...
              >
                ...
                <h3 className="text-xl fontheading text-white mb-2">
                  {benefit.title}
                </h3>
                <p className="text-gray-400 fontbody2 text-sm leading-relaxed">
                  {benefit.description}
                </p>
              </motion.div>
            ))}
        ...
        >
          <motion.div variants={item} className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto fontbody">
              Join our mission to revolutionize payments in India. We&apos;re
              hiring talented individuals across multiple roles.
            </p>
          </motion.div>
              ...
              >
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-300 fontbody mb-6">
                      {job.description}
                    </p>

                    {/* Responsibilities */}
                    <div className="mb-6">
                      <h4 className="text-lg fontheading text-emerald-400 mb-3">
                      ...
                      <ul className="space-y-2">
                        {job.responsibilities.map((resp, i) => (
                          <li
                            key={i}
                            className="text-gray-400 fontbody2 flex items-start gap-2"
                          >
                    ...
                    {/* Requirements */}
                    <div>
                      <h4 className="text-lg fontheading text-teal-400 mb-3">
                        Requirements:
                      </h4>
                      <ul className="space-y-2">
          ...
          >
            ...
            <p className="text-gray-400 fontbody mb-6 max-w-2xl mx-auto">
              ...
              resume and tell us how you can contribute to RupeeFlow&apos;s
              mission.
            </p>
            <a
