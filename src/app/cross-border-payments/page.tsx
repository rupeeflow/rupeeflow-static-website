  ...
  return (
    <div className="w-full relative">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 pt-36 pb-20 flex flex-col lg:flex-row items-center gap-12 lg:gap-10">
          ...
          >
            ...
            <h1 className="fontheading text-3xl sm:text-4xl lg:text-[2.8rem] leading-[1.2] text-white mb-5">
              Seamless <span className="text-emerald-400">Cross-Border</span>{' '}
              Payments, Simplified
            </h1>

            <p className="text-gray-400 max-w-lg text-sm md:text-base fontbody2 leading-relaxed mb-7">
              Send and receive international payments effortlessly with
              competitive exchange rates, real-time tracking, and full
            ...
            <div className="flex flex-wrap gap-6 mb-8">
              {[
                ...
                <div key={s.label}>
                  <p className="fontheading text-xl text-emerald-400">
                    {s.value}
                  </p>
                  <p className="text-xs text-gray-500 fontbody2 mt-0.5">
                    {s.label}
                  </p>
                </div>
              ))}
          ...
          >
            <div className="relative w-full max-w-[500px] h-[320px] sm:h-[380px] lg:h-[420px]">
              ...
              >
                ...
                <div>
                  <p className="text-[10px] text-gray-400 fontbody2">
                    Sent from India
                  </p>
                  <p className="text-sm font-bold text-white fontheading">
                    ₹4,15,000
                  </p>
                </div>
              </motion.div>
              ...
              >
                <p className="text-[10px] text-emerald-300 fontbody2 mb-0.5">
                  Live Rate
                </p>
                <p className="text-sm font-bold text-white fontheading">
                  1 USD = ₹83.21
              ...
              >
                ...
                <p className="text-xs font-semibold text-white fontheading">
                  Settled
                </p>
              </motion.div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="fontheading text-3xl md:text-4xl text-gray-900">
              How{' '}
              <span className="text-emerald-500">Cross-Border Payments</span>{' '}
              Work
            </h2>
          </div>
            ...
            <div className="flex-1 space-y-8 w-full max-w-lg">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1 fontbody2">
                    Monitor your payment in real time and get notified when
                    funds are settled to the recipient.
                  </p>
                </div>
              </motion.div>
              ...
              <div className="relative w-full max-w-[480px] h-[380px] sm:h-[440px] lg:h-[500px] rounded-2xl overflow-hidden shadow-xl">
                ...
                <div className="absolute bottom-8 left-1/2 -translate-x-1/2 bg-white rounded-2xl shadow-xl px-5 py-3 flex items-center gap-4 z-10">
                  ...
                  <div className="ml-2 border-l border-gray-200 pl-3">
                    <p className="text-[10px] text-gray-500 fontbody2">
                      Transfer
                    </p>
                    <p className="text-sm font-bold text-gray-900 fontheading">
                      £2,400
                    </p>
                  </div>
                </div>
          ...
          <div className="space-y-24">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
              ...
              >
                ...
                <p className="text-sm md:text-base text-gray-500 fontbody2 leading-relaxed mb-6 max-w-xl">
                  Send and receive payments in over 30 currencies across 100+
                  countries. Rupeeflow handles currency conversion automatically
                  with competitive exchange rates, eliminating the complexity of
                  managing multiple foreign accounts.
                </p>
              ...
              >
                <div className="w-full max-w-[380px] bg-white rounded-2xl border border-gray-200 shadow-lg p-5">
                  <div className="flex items-center justify-between mb-4">
                    <p className="text-sm fontheading text-gray-800">
                      Live Exchange Rates
                    </p>
                  ...
                  <div className="space-y-2.5">
                    {[
                      ...
                      >
                        ...
                        <span className="text-xs text-gray-500 fontbody2 flex-1">
                          {r.pair}
                        </span>
                        <span className="text-sm font-bold text-gray-900 fontheading">
                          {r.rate}
                        </span>
                        <span
                          className={`text-[10px] font-semibold ${r.up ? 'text-emerald-600' : 'text-red-500'}`}
                        >
                          {r.change}
                        </span>
                      </div>
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-10 lg:gap-16">
              ...
              >
                ...
                <p className="text-sm md:text-base text-gray-500 fontbody2 leading-relaxed mb-6 max-w-xl">
                  Save on every international transaction with our transparent
                  pricing model. Rupeeflow offers real-time exchange rates with
                  minimal markup and no hidden charges, ensuring you always get
                  best value compared to traditional banking channels.
                </p>
                {/* <Link href="#" className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full border-2 border-emerald-500 text-emerald-600 text-sm font-semibold hover:bg-emerald-50 transition-colors">
                  Get Started
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                <div className="w-full max-w-[380px] bg-white rounded-2xl border border-gray-200 shadow-lg p-5">
                  <p className="text-xs text-gray-500 fontbody2 mb-4">
                    Fee Comparison — $1,000 transfer
                  </p>
                    ...
                    {[
                      ...
                      >
                        <div className="flex-1">
                          <p
                            className={`text-xs font-semibold fontheading ${row.highlight ? 'text-emerald-700' : 'text-gray-700'}`}
                          >
                            {row.name}
                          </p>
                          <p className="text-[10px] text-gray-400 fontbody2 mt-0.5">
                            Fee: {row.fee} · FX: {row.fx}
                          </p>
                        </div>
                        <div
                          className={`text-sm font-bold fontheading ${row.highlight ? 'text-emerald-600' : 'text-gray-500'}`}
                        >
                          {row.total}
                        </div>
                        {row.highlight && (
                  ...
                  <p className="text-[10px] text-center text-emerald-600 mt-3 font-semibold">
                    Save up to 93% on every transfer
                  </p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="fontheading text-xl md:text-2xl text-gray-900">
                    Built-in Regulatory Compliance & KYC
                  </h3>
                </div>
                <p className="text-sm md:text-base text-gray-500 fontbody2 leading-relaxed mb-6 max-w-xl">
                  Navigate the complexities of international payment regulations
                  effortlessly. Rupeeflow is fully compliant with RBI
                  guidelines, FEMA regulations, and global AML/KYC standards,
                  ensuring every cross-border transaction meets all legal
                  requirements.
                </p>
                {/* <Link href="#" className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full border-2 border-emerald-500 text-emerald-600 text-sm font-semibold hover:bg-emerald-50 transition-colors">
                  Get Started
                ...
                <div className="w-full max-w-[380px] bg-white rounded-2xl border border-gray-200 shadow-lg p-5">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-4">
                    {[
                      ...
                      <div
                        key={c.badge}
                        className={`border rounded-xl p-3.5 ${c.color}`}
                      >
                        <div className="flex items-center gap-1.5 mb-1">
                          ...
                          <p className="text-xs font-bold fontheading">
                            {c.badge}
                          </p>
                        </div>
                        <p className="text-[10px] opacity-70 fontbody2">
                          {c.sub}
                        </p>
                      </div>
                    ))}
                  ...
                  <div className="bg-gray-50 rounded-xl px-4 py-3 flex items-center gap-3">
                    ...
                    <p className="text-[11px] text-gray-600 fontbody2">
                      Transactions auto-reported under LRS guidelines
                    </p>
                  </div>
                </div>
              </motion.div>
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-10 lg:gap-16">
              ...
              >
                ...
                <p className="text-sm md:text-base text-gray-500 fontbody2 leading-relaxed mb-6 max-w-xl">
                  Know exactly where your money is at every step. Rupeeflow
                  provides end-to-end visibility into your cross-border
                  transactions with real-time status updates, instant
                  notifications on settlement, and detailed audit trails.
                </p>
                {/* <Link href="#" className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full border-2 border-emerald-500 text-emerald-600 text-sm font-semibold hover:bg-emerald-50 transition-colors">
                  Get Started
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                <div className="w-full max-w-[380px] bg-white rounded-2xl border border-gray-200 shadow-lg p-5">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[10px] bg-emerald-50 text-emerald-600 border border-emerald-200 px-2.5 py-0.5 rounded-full font-semibold">
                      Settled
                    </span>
                  </div>
                  ...
                  <div className="space-y-0">
                    {[
                      ...
                      {
                        label: 'Forex Conversion',
                        time: '10:04 AM',
                        done: true,
                      },
                      {
                        label: 'In Transit (SWIFT)',
                        time: '10:15 AM',
                        done: true,
                      },
                      {
                        label: 'Settled to Recipient',
                        time: '11:40 AM',
                        done: true,
                      },
                    ].map((step, i, arr) => (
                      <div key={step.label} className="flex items-start gap-3">
                        <div className="flex flex-col items-center">
                          <div
                            className={`w-5 h-5 rounded-full flex items-center justify-center shrink-0 ${step.done ? 'bg-emerald-500' : 'bg-gray-200'}`}
                          >
                            {step.done && (
                              <svg
                                className="w-3 h-3 text-white"
                          ...
                          {i < arr.length - 1 && (
                            <div className="w-px h-6 bg-emerald-200 my-0.5" />
                          )}
                        </div>
                        <div className="flex-1 pb-1">
                          <div className="flex items-center justify-between">
                            <p
                              className={`text-[11px] font-semibold fontheading ${step.done ? 'text-gray-800' : 'text-gray-400'}`}
                            >
                              {step.label}
                            </p>
                            <p className="text-[10px] text-gray-400 fontbody2">
                  ...
                  <div className="w-12 h-12 shrink-0 rounded-full bg-emerald-500 flex items-center justify-center">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M10 20l4-16m4 4l4 4-4 4m-8-8L2 12l4 4"
                      />
                    </svg>
                  </div>
                  <h3 className="fontheading text-xl md:text-2xl text-gray-900">
                    Seamless API Integration for Your Platform
                  </h3>
                </div>
                <p className="text-sm md:text-base text-gray-500 fontbody2 leading-relaxed mb-6 max-w-xl">
                  Integrate cross-border payment capabilities directly into your
                  platform with Rupeeflow&apos;s developer-friendly APIs. Our
              ...
              >
                <div className="w-full max-w-[380px] bg-[#0F1117] rounded-2xl border border-gray-700 shadow-xl overflow-hidden">
                  ...
                  <div className="flex items-center gap-2 px-4 py-3 bg-[#1A1D27] border-b border-gray-700">
                    ...
                    <span className="ml-2 text-[11px] text-gray-400 fontbody2">
                      rupeeflow-api.js
                    </span>
                  </div>
                  {/* Code */}
                  ...
                  <div className="flex gap-2 px-4 pb-4">
                    ...
                    <span className="text-[10px] bg-blue-500/20 text-blue-400 border border-blue-500/30 px-2.5 py-0.5 rounded-full">
                      Webhooks
                    </span>
                    <span className="text-[10px] bg-purple-500/20 text-purple-400 border border-purple-500/30 px-2.5 py-0.5 rounded-full">
                      Sandbox
                    </span>
                  </div>
                </div>
      ...
      <section className="relative py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="fontheading text-3xl md:text-4xl text-gray-900">
              Rupeeflow{' '}
              <span className="text-emerald-500">Cross-Border Features</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white border border-gray-200 rounded-2xl p-7 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-500 fontbody2 leading-relaxed">
                Receive international payments faster with same-day or next-day
                settlement across supported corridors.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-7 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-500 fontbody2 leading-relaxed">
                Hold balances in multiple currencies and convert when the rates
                are favorable for your business.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-7 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-500 fontbody2 leading-relaxed">
                Automatically match incoming international payments with
                invoices and generate detailed settlement reports.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-7 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-500 fontbody2 leading-relaxed">
                Monitor all regulatory requirements, documentation status, and
                transaction limits from a centralized dashboard.
              </p>
            </div>
          </div>
        </div>
      ...
      <FAQAccordion
        ...
        subtitle="Everything you need to know about RupeeFlow Cross-Border Payments."
      />
    </div>
  )
}
