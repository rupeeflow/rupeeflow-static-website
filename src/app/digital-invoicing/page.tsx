...
import EInvoicingCalculator from './components/EInvoicingCalculator';
...
export default function DigitalInvoicingPage() {
  return (
    <main>
      <WebPageSchema
        title="GST-Compliant E-Invoicing - RupeeFlow"
        description="Generate GST-compliant digital invoices instantly with automatic IRP integration. 100% compliant, 70% faster invoice generation, and 90% error reduction."
        url="https://rupeeflow.com/digital-invoicing"
      />
      <FAQSchema faqs={faqs} />

      <HeroSection />
      <EInvoicingCalculator />
      <BenefitsGrid />
      <ComplianceSection />
      <StatsSection />
      <HowItWorksSection />
