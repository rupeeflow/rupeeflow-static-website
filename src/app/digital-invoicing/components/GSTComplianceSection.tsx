...
import { FileCheck, Shield, Clock, Zap, CheckCircle, TrendingUp } from 'lucide-react';
...
export default function GSTComplianceSection() {
  ...
  useEffect(() => {
    ...
    }, 4500); // Slightly offset timing for visual interest
      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-12">
        ...
        >
          ...
          <p className="fontbody2 text-lg text-gray-600 max-w-2xl mx-auto">
            Seamless integration across all your devices with real-time compliance tracking
          </p>
        </motion.div>

        {/* Main Feature Image with Animated Cards */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
