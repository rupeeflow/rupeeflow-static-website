...
const repaymentOptions = [
  {
    title: 'Monthly EMI',
    desc: 'Fixed monthly installments from your overseas account. Predictable and easy to manage.',
    tenure: '6-36 months',
  ...
  },
  {
    ...
    desc: 'Pay every 3 months. Ideal for those with quarterly bonuses or irregular income.',
    tenure: '12-36 months',
  ...
  {
    title: 'Pay When Used',
    desc: 'Credit line model. Pay only when you withdraw funds. Interest only on utilized amount.',
    tenure: 'Revolving',
    frequency: 'Flexible',
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16 mb-12">
          ...
          >
            <div className="w-full max-w-[500px] rounded-3xl overflow-hidden border-2 border-gray-200 shadow-lg">
              <Image
                src="/nri-emergency-loans/repayment.jpeg"
                alt="Flexible repayment options for NRI loans"
                width={500}
                height={450}
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700 fontbody2 text-sm leading-relaxed">
                All repayments are processed through secure international banking channels with full compliance 
                to RBI and FEMA regulations. Auto-debit facility available from your overseas bank account for 
