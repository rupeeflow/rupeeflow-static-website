...
const steps = [
  {
    number: '01',
    title: 'Apply Online',
    desc: 'Fill application in your preferred language. Provide your details and family member information in India.',
    icon: '/payments/payment-links.svg',
  },
  {
    number: '02',
    title: 'Quick Verification',
    desc: 'Our team verifies your documents and employment details. Get approval within hours.',
    icon: '/Developer-friendly/security-card.svg',
  },
  {
    number: '03',
    title: 'Funds Disbursed',
    desc: 'Money is transferred directly to your family member in India within 24 hours of approval.',
    icon: '/home/wallet.svg',
  },
  {
    number: '04',
    title: 'Flexible Repayment',
    desc: 'Start repayment as per your chosen plan. Pay only when you use the credit line.',
      ...
      <Container>
        ...
        >
          ...
          <p className="fontbody2 text-gray-600 text-lg max-w-3xl mx-auto">
            Help your family in 4 simple steps
          </p>
        </motion.div>
