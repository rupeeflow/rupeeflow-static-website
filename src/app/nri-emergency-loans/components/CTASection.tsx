...
export default function CTASection() {
  return (
    <section id="apply" className="relative bg-gradient-to-br from-emerald-600 to-teal-600 py-20 md:py-28 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-black/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <Container>
        ...
        >
          ...
          >
            Join thousands of NRIs who trust RupeeFlow for emergency financial support. 
            Apply now in your preferred language and get funds to India in 24 hours.
          </motion.p>
          ...
          >
            ...
            >
              ...
              Apply for NRI Emergency Loan
            </a>
            <a
              href="/support"
              className="inline-flex items-center justify-center px-10 py-5 rounded-full border-2 border-white text-white font-bold text-lg hover:bg-white/10 transition-all duration-300"
            >
              Talk to NRI Support
            </a>
          </motion.div>
