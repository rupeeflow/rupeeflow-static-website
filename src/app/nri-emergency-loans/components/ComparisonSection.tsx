...
const comparisonData = [
  {
    ...
    traditional: 'Visit India required',
    nri: '100% online',
  },
  {
  ...
  {
    feature: 'Disbursal Time',
    traditional: '7-15 days',
    nri: '24 hours',
  },
  {
    feature: 'Documentation',
    traditional: 'Extensive paperwork',
    nri: 'Minimal digital docs',
  },
  {
    feature: 'Beneficiary',
    traditional: 'Self only',
    nri: 'Family in India',
  },
  {
    feature: 'Support',
    traditional: 'Business hours',
    nri: '24/7 global support',
  },
]
      ...
      <Container>
        ...
        >
          ...
          <p className="fontbody2 text-gray-600 text-lg max-w-3xl mx-auto">
            See how our NRI Emergency Loans compare to traditional lending options
          </p>
        </motion.div>
        ...
        >
          <p className="text-gray-600 fontbody2 mb-6">
            Experience hassle-free emergency funding for your family
          </p>
          <a
            href="#apply"
