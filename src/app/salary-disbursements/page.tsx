  ...
  return (
    <div className="w-full bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden">
      <div className="bg-gradient-to-r from-emerald-500 to-teal-500 px-5 py-4 flex items-center justify-between">
        ...
        <motion.button
          whileTap={{ scale: 0.95 }}
          className="bg-white text-emerald-600 text-xs font-bold px-4 py-2 rounded-full shadow"
        >
          Pay All →
        </motion.button>
      </div>
      ...
      <div className="px-5 pb-4 flex gap-2">
        {['NEFT', 'RTGS', 'IMPS', 'UPI'].map(mode => (
          <span
            key={mode}
            className="text-[10px] font-semibold bg-blue-50 text-blue-600 px-2.5 py-1 rounded-full border border-blue-100"
          >
            {mode}
          </span>
        ))}
    ...
    <div className="w-full bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden">
      <div className="px-5 pt-5 pb-4 border-b border-gray-100">
        <div className="flex items-center justify-between mb-1">
          <p className="text-sm font-bold text-gray-800">
            Salary Batch #2025-01
          </p>
          <span className="text-[10px] font-semibold bg-amber-100 text-amber-600 px-2.5 py-1 rounded-full">
            Pending CFO
          </span>
        </div>
        ...
        {steps.map((step, i) => (
          <div key={step.role} className="flex gap-4">
            <div className="flex flex-col items-center">
              ...
              {i < steps.length - 1 && (
                <div
                  className={`w-0.5 h-10 mt-1 ${step.done ? 'bg-emerald-300' : 'bg-gray-200'}`}
                />
              )}
            </div>
            <motion.div
      ...
      <div className="px-5 pb-5 flex gap-2">
        <motion.button
          ...
          className="flex-1 bg-emerald-500 text-white text-xs font-bold py-2.5 rounded-xl"
        >
          Approve & Release
        </motion.button>
        <motion.button
          whileHover={{ scale: 1.02 }}
          className="px-4 bg-gray-100 text-gray-500 text-xs font-bold py-2.5 rounded-xl"
        >
          Reject
        </motion.button>
      </div>
  ...
  const events = [
    {
      ...
      sub: '387 records uploaded',
      color: 'bg-blue-500',
    },
    {
      time: '10:03 AM',
      label: 'Approved by CFO',
      sub: 'Authorization complete',
      color: 'bg-emerald-500',
    },
    {
      time: '10:04 AM',
      label: '312 payments sent',
      sub: 'NEFT · RTGS dispatched',
      color: 'bg-emerald-400',
    },
    {
      time: '10:06 AM',
      label: '3 failed — retrying',
      sub: 'Invalid account detected',
      color: 'bg-amber-500',
    },
    {
      time: '10:08 AM',
      label: 'All payments settled',
      sub: '387/387 successful',
      color: 'bg-emerald-500',
    },
  ]
  return (
        ...
        <div className="bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-emerald-500">
              Last synced: 2 min ago · 1,247 employees
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 w-full flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          >
            ...
            <p className="text-gray-400 max-w-lg text-base md:text-lg fontbody2 leading-relaxed mb-10">
              Your ultimate solution for accurate, compliant, and stress-free
              salary disbursement. Advanced payroll management designed to meet
              your workforce&apos;s diverse needs.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <h2 className="fontheading text-3xl md:text-4xl text-gray-900">
              Streamline Your <span className="text-emerald-500">Payroll</span>{' '}
              with Rupeeflow
            </h2>
          </motion.div>
          ...
          <div className="space-y-24">
            ...
            >
              <div className="flex-1">
                ...
                <p className="text-sm md:text-base text-gray-500 fontbody2 leading-relaxed mb-6 max-w-xl">
                  Pay your entire workforce in a single click. Upload salary
                  data in bulk via CSV or use our API to automate monthly
                  payroll runs. Rupeeflow handles NEFT, RTGS, IMPS, and UPI
            ...
            >
              <div className="flex-1">
                ...
                <p className="text-sm md:text-base text-gray-500 fontbody2 leading-relaxed mb-6 max-w-xl">
                  Set up configurable maker-checker approval hierarchies for
                  salary batches. Ensure every disbursement is verified by
                  authorized personnel before execution, maintaining compliance
                  and preventing unauthorized payouts.
                </p>
                {/* <Link href="#" className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full border-2 border-emerald-500 text-emerald-600 text-sm font-semibold hover:bg-emerald-50 transition-colors">
                  Get Started
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            >
              <div className="flex-1">
                ...
                <p className="text-sm md:text-base text-gray-500 fontbody2 leading-relaxed mb-6 max-w-xl">
                  Monitor every salary payment in real time from initiation to
                  completion. Get instant notifications for successful
                  transfers, failed transactions, and pending approvals.
                </p>
                {/* <Link href="#" className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full border-2 border-emerald-500 text-emerald-600 text-sm font-semibold hover:bg-emerald-50 transition-colors">
                  Get Started
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            >
              <div className="flex-1">
                ...
                <p className="text-sm md:text-base text-gray-500 fontbody2 leading-relaxed mb-6 max-w-xl">
                  Connect Rupeeflow with your existing ERP, HRMS, or accounting
                  software effortlessly. Sync employee data, automate payroll
                  runs, and eliminate manual data entry.
                </p>
      ...
      <section className="relative py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <h2 className="fontheading text-3xl md:text-4xl text-gray-900">
              Rupeeflow{' '}
              <span className="text-emerald-500">Salary Disbursement</span>{' '}
              Features
            </h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {[
              {
                Icon: WalletIcon,
                title: 'One-Click Bulk Payroll',
                desc: 'Pay all employees simultaneously with a single batch upload.',
              },
              {
                Icon: ClockIcon,
                title: 'Scheduled Payroll',
                desc: 'Set recurring schedules for automatic salary disbursement.',
              },
              {
                Icon: ApprovalIcon,
                title: 'Maker-Checker Approvals',
                desc: 'Dual authorization for every salary batch before processing.',
              },
              {
                Icon: CloudIcon,
                title: 'Cloud-Based Platform',
                desc: 'Access your payroll dashboard from anywhere, anytime.',
              },
              {
                Icon: AnalyticsIcon,
                title: 'Payroll Analytics',
                desc: 'Detailed insights into salary costs, trends, and department breakdowns.',
              },
              {
                Icon: AdvancedAnalyticsIcon,
                title: 'Advanced Reporting',
                desc: 'Generate custom reports for tax filing, audits, and compliance.',
              },
              {
                Icon: DataMmgIcon,
                title: 'Employee Data Management',
                desc: 'Centralized employee records with bank details and salary history.',
              },
              {
                Icon: MultiSupportIcon,
                title: 'Multi-Channel Support',
                desc: 'Disburse via NEFT, RTGS, IMPS, or UPI based on your needs.',
              },
              {
                Icon: ERPIcon,
                title: 'ERP Integration',
                desc: 'Sync with Zoho, Tally, SAP, and other platforms seamlessly.',
              },
              {
                Icon: CrossRoundedIcon,
                title: 'Error Handling',
                desc: 'Auto-detect failed transactions and retry with smart error resolution.',
              },
              ...
              >
                ...
                <h3 className="fontheading text-sm text-gray-900 mb-2">
                  {title}
                </h3>
