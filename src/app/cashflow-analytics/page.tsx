...
import CashflowAnalyticsCalculator from './components/CashflowAnalyticsCalculator';
...
export default function CashflowAnalyticsPage() {
  return (
    <main>
      <WebPageSchema
        title="Cashflow Forecasting & Liquidity Management - RupeeFlow"
        description="Forecast cashflow with 94% accuracy. 13-week rolling forecasts, scenario planning, liquidity alerts, and working capital optimization for complete cash visibility."
        url="https://rupeeflow.com/cashflow-analytics"
      />
      <FAQSchema faqs={faqs} />

      <HeroSection />
      <CashflowAnalyticsCalculator />
      <BenefitsGrid />
      <StatsSection />
      <HowItWorksSection />
      <FAQSection />
