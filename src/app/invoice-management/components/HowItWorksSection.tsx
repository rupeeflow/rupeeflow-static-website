...
import { Mail, GitBranch, Eye, Calendar, Activity } from 'lucide-react';
...
const steps = [
  {
    ...
    description: 'Invoices arrive via email, vendor portal, or manual upload',
  },
  {
    icon: GitBranch,
    title: 'Route for Approval',
    description: 'System automatically routes to appropriate approvers based on rules',
  },
  {
    icon: Eye,
    title: 'Review & Approve',
    description: 'Approvers review details, attachments, and approve or reject',
  },
  {
    icon: Calendar,
    title: 'Schedule Payment',
    description: 'Approved invoices are scheduled for payment based on terms',
  },
  {
    icon: Activity,
    title: 'Track Status',
    description: 'Monitor payment status and maintain complete audit trail',
  },
];
      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-12">
        ...
        >
          ...
          <p className="fontbody2 text-lg text-gray-600 max-w-2xl mx-auto">
            From receipt to payment in 5 streamlined steps
          </p>
        </motion.div>
