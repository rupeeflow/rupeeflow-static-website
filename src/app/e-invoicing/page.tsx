          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="mt-6 text-gray-400 text-lg leading-relaxed">
                Automate payment follow-ups with compliant, enterprise-grade
                reminder workflows. Improve collection efficiency, maintain
                professional customer communication, and accelerate cash flow
                with secure and intelligent automation.
              </p>
              ...
              <ul className="mt-8 space-y-4">
                {[
                  {
                    icon: BellRing,
                    text: 'Intelligent due-date & overdue alerts',
                  },
                  {
                    icon: CalendarClock,
                    text: 'Custom scheduling & escalation rules',
                  },
                  {
                    icon: Mail,
                    text: 'Multi-channel delivery with verified routing',
                  },
                  {
                    icon: ShieldCheck,
                    text: 'Secure, compliant & professional communication',
                  },
                ].map((item, i) => {
            ...
            <div className="mt-20 space-y-24">
              ...
              <div className="grid md:grid-cols-2 gap-14 items-center">
                <div>
                  <h3 className="text-xl font-bold text-black">
                    Choice of Reminder Types
                  </h3>
                  <p className="mt-4 text-gray-600">
                    Configure intelligent reminder workflows based on billing
                    cycles, customer behavior, and payment risk profiles.
                  </p>
              ...
              <div className="grid md:grid-cols-2 gap-14 items-center">
                ...
                <div className="order-1 md:order-2">
                  ...
                  <p className="mt-4 text-gray-600">
                    Gain real-time insights into payment patterns, reminder
                    performance, and receivable risk indicators.
                  </p>
                  <button className="mt-6 border border-emerald-500 text-emerald-600 px-5 py-2 rounded-lg text-sm font-bold hover:bg-emerald-50 transition">
                    View Insights →
                  </button>
              ...
              <div className="grid md:grid-cols-2 gap-14 items-center">
                <div>
                  ...
                  <p className="mt-4 text-gray-600">
                    Deliver secure, bank-grade payment links within reminders to
                    enable instant settlements through trusted payment channels.
                  </p>
                  <button className="mt-6 border border-emerald-500 text-emerald-600 px-5 py-2 rounded-lg text-sm font-bold hover:bg-emerald-50 transition">
                    Enable Payments →
                  </button>
              ...
              <div className="grid md:grid-cols-2 gap-14 items-center">
                ...
                <div className="order-1 md:order-2">
                  ...
                  <p className="mt-4 text-gray-600">
                    Define channels, escalation logic, and timing rules while
                    ensuring compliance and consistent customer communication.
                  </p>
                  <button className="mt-6 border border-emerald-500 text-emerald-600 px-5 py-2 rounded-lg text-sm font-bold hover:bg-emerald-50 transition">
                    Customize Workflow →
                  </button>
          ...
          <div className="max-w-6xl mx-auto px-6 text-center">
            ...
            <div className="mt-14 grid md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="group bg-white border border-white/10 p-7 rounded-xl text-left transition-all duration-300 hover:-translate-y-2 hover:border-emerald-400/40 hover:bg-gradient-to-br hover:from-[#02140f] hover:to-black hover:shadow-[0_0_25px_rgba(0,239,100,0.25)]"
                >
      ...
      <section className="py-24 bg-gray-100">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-center text-gray-500 mt-4 max-w-2xl mx-auto">
            Accelerate collections, strengthen customer engagement, and gain
            real-time visibility into payment behavior with intelligent reminder
            automation.
          </p>
          ...
          <div className="mt-20 space-y-24">
            ...
            <div className="grid md:grid-cols-2 gap-14 items-center">
              <div>
                ...
                <p className="mt-4 text-gray-800 leading-relaxed">
                  ...
                  while ensuring timely notifications that improve collection
            ...
            <div className="grid md:grid-cols-2 gap-14 items-center">
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="mt-4 text-gray-800 leading-relaxed">
                  Embed secure, bank-grade payment links directly within
                  reminders to enable instant customer payments and faster
                  settlements.
                </p>
            ...
            <div className="grid md:grid-cols-2 gap-14 items-center">
              <div>
                ...
                <p className="mt-4 text-gray-800 leading-relaxed">
                  Reduce Days Sales Outstanding through proactive reminders and
                  frictionless payment experiences that encourage faster
                  settlements.
                </p>
            ...
            <div className="grid md:grid-cols-2 gap-14 items-center">
              ...
              <div className="order-1 md:order-2">
                ...
                <p className="mt-4 text-gray-800 leading-relaxed">
                  Understand customer payment behavior to strengthen
                  relationships while maintaining professional, compliant
                  communication.
                </p>
            ...
            <div className="grid md:grid-cols-2 gap-14 items-center">
              <div>
                ...
                <p className="mt-4 text-gray-800 leading-relaxed">
                  ...
                  performance from a centralized, audit-ready dashboard.
                </p>
