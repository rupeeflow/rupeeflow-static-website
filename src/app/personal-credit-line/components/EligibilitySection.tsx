...
const eligibilityCriteria = [
  {
    ...
    desc: 'A decent credit history helps us assess your creditworthiness',
    icon: '/Developer-friendly/security-card.svg',
  },
  {
    title: 'Age',
    requirement: '21-60 Years',
    desc: 'You should be between 21 and 60 years of age to apply',
    icon: '/features/clock.svg',
  },
  {
    title: 'Monthly Income',
    requirement: '₹15,000+',
    desc: 'Regular monthly income from salary, business, or freelancing',
    icon: '/home/rupee.svg',
  },
  {
    title: 'Employment',
    requirement: 'Any Type',
    desc: 'Salaried, self-employed, freelancers, gig workers - all welcome',
      ...
      <Container>
        ...
        >
          ...
          <p className="fontbody2 text-gray-600 text-lg max-w-3xl mx-auto">
            Check if you qualify for Personal Credit Line
          </p>
        </motion.div>
