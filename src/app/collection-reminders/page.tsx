...
export default function CollectionRemindersPage() {
  return (
    <main>
      <WebPageSchema
        title="Automated Payment Reminders - RupeeFlow"
        description="Automate payment reminders via SMS, email, and WhatsApp. Improve collection rates by 35% and reduce DSO by 15 days with smart, automated reminders."
        url="https://rupeeflow.com/collection-reminders"
      />
      <FAQSchema faqs={faqs} />

      <HeroSection />
      <PaymentRemindersCalculator />
      <BenefitsGrid />
      <StatsSection />
      <HowItWorksSection />
      <UseCasesSection />
