        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="fontheading text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">
              ...
              <span className="text-emerald-500">Collection Rates</span>
            </h1>

            {/* Description */}
            <p className="fontbody2 text-lg md:text-xl text-gray-300 leading-relaxed">
              Send smart, automated reminders via SMS, email, and WhatsApp.
              Improve collection rates by 35% and reduce DSO by 15 days.
            </p>

            {/* Trust indicators */}
            <div className="flex flex-wrap gap-4">
              {['RBI Compliant', '100% Secure', 'Bank-Grade Encryption'].map(
                indicator => (
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-10 h-10 rounded-lg bg-${reminder.color}-500/20 flex items-center justify-center`}
                        >
                          <Icon
                            className={`w-5 h-5 text-${reminder.color}-400`}
                          />
                        </div>
                        <div>
