...
const benefits = [
  {
    ...
    description:
      'Send automated reminders via SMS, Email, and WhatsApp to reach customers on their preferred channel.',
  },
  {
    icon: Calendar,
    title: 'Smart Scheduling',
    description:
      'AI-powered scheduling based on payment behavior and customer preferences for optimal results.',
  },
  {
    icon: FileText,
    title: 'Customizable Templates',
    description:
      'Create personalized reminder templates with your branding and custom messaging.',
  },
  {
    icon: Activity,
    title: 'Real-Time Tracking',
    description:
      'Track delivery status, open rates, and customer responses in real-time dashboards.',
  },
  {
    icon: Zap,
    title: 'Automated Escalation',
    description:
      'Set up automatic escalation workflows for overdue payments with increasing urgency.',
  },
  {
    icon: LinkIcon,
    title: 'Payment Link Integration',
    description:
      'Include secure payment links in reminders for instant one-click payments.',
  },
]
      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-12">
        ...
        >
          ...
          <p className="fontbody2 text-lg text-gray-600 max-w-2xl mx-auto">
            Everything you need to automate payment reminders and improve cash
            flow
          </p>
        </motion.div>
          ...
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="fontbody2 text-gray-600 leading-relaxed">
                  {benefit.description}
                </p>
              </motion.div>
            )
            ...
            >
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-[252px] h-10 bg-white/40 rounded-full blur-2xl"
                ...
                <motion.div
                  ...
                  whileHover={{
                    boxShadow:
                      '0 30px 60px -12px rgba(0, 0, 0, 0.5), 0 0 40px rgba(16, 185, 129, 0.4), inset 0 0 20px rgba(255, 255, 255, 0.1)',
                    transition: { duration: 0.4 },
                  }}
                ...
                >
                  ...
                  {/* Phone Notch */}
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-20 h-5 bg-white rounded-b-2xl z-30" />
                </motion.div>
