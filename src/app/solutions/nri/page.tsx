...
const solutions = [
  {
    ...
    description:
      'Send money to India instantly with competitive exchange rates and low fees.',
    features: [
  ...
  },
  {
    ...
    description:
      'Quick access to funds for family emergencies in India without lengthy paperwork.',
    features: [
  ...
  },
  {
    ...
    description:
      'Pay utility bills, insurance premiums, and other bills in India from anywhere.',
    features: [
  ...
  },
  {
    ...
    description:
      'Hold and transact in multiple currencies with a single account.',
    features: [
...
const benefits = [
  {
    ...
    description:
      'Money reaches India in minutes, not days. Perfect for urgent needs.',
    Icon: LightingIcon,
  },
  {
    title: 'Best Rates',
  ...
  },
  {
    ...
    description:
      'RBI approved and fully compliant with international regulations.',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8">
                Send money, pay bills, and manage finances in India seamlessly
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive financial services to manage your India connections
              effortlessly
            </p>
          </motion.div>
