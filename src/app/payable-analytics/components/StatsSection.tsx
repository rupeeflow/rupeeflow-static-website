...
const stats = [
  { value: 8, suffix: '%', label: 'Savings Identified' },
  { value: 98, suffix: '%', label: 'Spend Visibility' },
  { value: 92, suffix: '%', label: 'Forecast Accuracy' },
      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-12">
        ...
        >
          ...
          <p className="fontbody2 text-lg text-gray-300 max-w-2xl mx-auto">
            Real results from businesses using payable analytics
          </p>
        </motion.div>
