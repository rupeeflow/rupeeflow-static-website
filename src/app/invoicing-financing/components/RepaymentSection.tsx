...
const financingOptions = [
  {
    ...
    desc: 'Finance one invoice at a time. Perfect for occasional cash flow needs or testing our service.',
    advance: '80%',
  ...
  },
  {
    ...
    desc: 'Choose which invoices to finance. Flexibility to manage cash flow based on your needs.',
    advance: '80%',
    frequency: 'As Needed',
  ...
  },
  {
    ...
    desc: 'Ongoing credit line for regular financing needs. Finance multiple invoices continuously.',
    advance: '80%',
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4">
                        <div>
                          ...
                          <div className="text-gray-500 text-xs">upfront</div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="text-gray-500 text-xs">financing</div>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700 fontbody2 text-sm leading-relaxed">
                You receive 80% of the invoice value upfront. When your customer pays the full invoice amount, 
                you receive the remaining 20% minus our service fee (typically 2-5% depending on payment terms). 
                We handle all collection activities professionally to maintain your customer relationships.
              </p>
            </div>
          </div>
        </motion.div>
