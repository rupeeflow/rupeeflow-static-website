...
const eligibilityCriteria = [
  {
    title: 'Business Type',
    requirement: 'B2B Operations',
    desc: 'Must be a B2B business with invoices to creditworthy corporate customers',
    icon: '/business/msme.svg',
  },
  {
    title: 'Business Age',
    requirement: '1+ Year',
    desc: 'Your business should have at least 1 year of operational history',
    icon: '/features/clock.svg',
  },
  {
    title: 'Invoice Value',
    requirement: '₹1L - ₹50L',
    desc: 'Invoice amount between ₹1 lakh to ₹50 lakhs with 30-90 days payment terms',
    icon: '/payments/payment-links.svg',
  },
  {
    title: 'Customer Quality',
    requirement: 'Creditworthy',
    desc: 'Your customer should have good credit history and payment track record',
      ...
      <Container>
        ...
        >
          ...
          <p className="fontbody2 text-gray-600 text-lg max-w-3xl mx-auto">
            Check if your invoices qualify for financing
          </p>
        </motion.div>
