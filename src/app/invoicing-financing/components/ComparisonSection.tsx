...
const comparisonData = [
  {
    ...
    invoiceFinancing: 'Asset financing',
  },
  {
  ...
  {
    feature: 'Collateral',
    traditional: 'Property/Assets',
    invoiceFinancing: 'Invoice itself',
  },
  {
    feature: 'Balance Sheet',
    traditional: 'Shows as debt',
    invoiceFinancing: 'Not a liability',
  },
  {
    feature: 'Credit Score',
    traditional: 'Affects score',
    invoiceFinancing: 'No impact',
  },
  {
    feature: 'Repayment',
    traditional: 'Fixed EMI',
    invoiceFinancing: 'Customer pays',
  },
]
      ...
      <Container>
        ...
        >
          ...
          <p className="fontbody2 text-gray-600 text-lg max-w-3xl mx-auto">
            See how invoice financing compares to traditional business loans
          </p>
        </motion.div>
        ...
        >
          <p className="text-gray-600 fontbody2 mb-6">
            Experience better cash flow without taking on debt
          </p>
          <a
            href="#apply"
