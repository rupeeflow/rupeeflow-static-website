...
export default function SmartPOSPage() {
  ...
  return (
    <main className="relative min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                <div className="inline-block mb-4 px-4 py-2 rounded-full bg-emerald-500/20 border border-emerald-500/30">
                  <span className="text-emerald-400 text-sm font-semibold">Smart POS Solutions</span>
                </div>
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6">
                  India's Smartest POS for Kirana & Retail Stores
                </h1>
                <p className="text-xl text-gray-300 mb-8">
                  Accept every payment — UPI, card, contactless — with T+1 settlement, daily WhatsApp reports, and a built-in credit score. No hidden charges.
                </p>
      ...
      <section ref={ref} className="py-16 md:py-24 bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col lg:flex-row items-center gap-12 mb-12 md:mb-16">
            ...
            >
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 transition-colors duration-300">
                From smart terminals to simple QR codes — we have the right solution for every business
              </p>
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div
              ...
              className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-emerald-500"
            >
              ...
              <Link
                href="/contact"
                className="block w-full text-center px-6 py-3 rounded-full bg-emerald-600 text-white font-semibold hover:bg-emerald-700 transition-all duration-300"
              >
                Get Smart POS
              </Link>
            </motion.div>
            ...
            <motion.div
              ...
              animate={isInView ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.6, delay: 0.2 }}
              className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border-2 border-emerald-500 relative"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 mb-12">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Your money reaches your bank account by 9 AM the next morning — no delays, no holds, no weekend exceptions.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 30 }}
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-8 mb-12">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Every evening at 7 PM, get your day's collection summary directly on WhatsApp. Total received, pending, and top payment methods — in your language.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: -30 }}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 mb-12">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Government mandate — 0% charge on all UPI transactions. Card transactions charged at 0.3%–0.9% based on card type. No hidden platform fees from RupeeFlow.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 30 }}
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-8">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Every transaction you process builds your RupeeFlow Business Score. After 90 days, unlock ₹25,000–₹5,00,000 in working capital credit — no branch visit, no guarantor, no paperwork. Just your transaction history.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: -30 }}
            ...
            {[
              {
                ...
                description: 'Accept UPI + card. Daily settlement. Build credit score from day one.',
              },
              {
                image: '/Smart Pos/Medical Shops & Pharmacies.png',
                title: 'Medical Shops & Pharmacies',
                description: 'Card EMI for customers. GST receipts. Working capital credit based on sales.',
              },
              {
                image: '/Smart Pos/Textile & Clothing Stores.png',
                title: 'Textile & Clothing Stores',
                description: 'High-ticket card transactions. Festival season pre-approved credit.',
              },
              {
                image: '/Smart Pos/Restaurants & Dhabas.png',
                title: 'Restaurants & Dhabas',
                description: 'High-volume UPI. Daily cash flow credit line. Zero MDR on UPI.',
              },
              {
                image: '/Smart Pos/Coaching & Education.png',
                title: 'Coaching & Education',
                description: 'NACH AutoPay for fee collection. Recurring mandates. GST invoicing.',
              },
              {
                image: '/Smart Pos/Clinics & Diagnostic Centres.png',
                title: 'Clinics & Diagnostic Centres',
                description: 'Card + UPI. Insurance payment support. Proper receipt generation.',
              },
            ].map((segment, index) => (
              <motion.div
                key={index}
                ...
                className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700 hover:border-emerald-500"
              >
      ...
      <section className="py-16 md:py-24 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-6xl md:text-7xl font-bold text-gray-900 dark:text-gray-100 mb-4">
              How It Works
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            {[
              {
                step: '01',
                title: 'Apply Online',
                description: 'Fill a simple form. Submit your Aadhaar + PAN + bank details. KYC verified in under 10 minutes.',
                icon: '/features/bill.svg',
              },
              {
                step: '02',
                title: 'Get Your Device',
                description: 'POS machine delivered to your store within 3–5 working days. QR code generated instantly online.',
                icon: '/payouts/bulk-payouts.svg',
              },
              {
                step: '03',
                title: 'Start Accepting Payments',
                description: 'Accept UPI, card, and contactless from day one. No training needed. Machine is plug and play.',
                icon: '/payments/payment-gateway.svg',
              },
              {
                step: '04',
                title: 'Money in Your Account',
                description: 'T+1 settlement every morning by 9 AM. Download reports anytime from your RupeeFlow dashboard or WhatsApp.',
              ...
              >
                <div className="text-center">
                  <motion.div 
                    className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-emerald-100 text-emerald-600 mb-4"
                  ...
                  <motion.div 
                    className="text-5xl font-bold text-emerald-500/20 mb-2"
                ...
                {index < 3 && (
                  <motion.div 
                    className="hidden lg:block absolute top-8 -right-4 w-8 h-0.5 bg-emerald-200"
                    initial={{ scaleX: 0 }}
            ...
            {[
              {
                ...
                answer: 'The machine is provided at zero upfront cost for eligible merchants. A refundable security deposit may apply for the hardware device.',
              },
              {
                question: 'What payments can I accept?',
                answer: 'UPI (all apps — GPay, PhonePe, Paytm, BHIM), Visa, Mastercard, RuPay, Amex, contactless NFC, and QR code payments.',
              },
              {
                question: 'When will I receive my settlement?',
                answer: 'Next business day by 9 AM directly to your registered bank account.',
              },
              {
                question: 'What is MDR? Will I be charged?',
                answer: 'UPI payments — 0% MDR (government mandate). Debit cards — 0.4%. Credit cards — 0.9%. No additional charges from RupeeFlow.',
              },
              {
                question: 'What if the machine stops working?',
                answer: 'Call RupeeFlow support or WhatsApp us. Replacement within 24–48 hours for verified merchants.',
              },
              {
                question: 'How does the credit score work?',
                answer: 'Every transaction processed through your RupeeFlow POS builds your Business Score. After 90 days, you become eligible for instant working capital loans up to ₹5,00,000 — no collateral required.',
              },
            ].map((faq, index) => (
              <motion.div
                key={index}
