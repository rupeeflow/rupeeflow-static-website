...
const benefits = [
  {
    ...
    desc: 'Get funds within 24 hours of approval. No waiting weeks for traditional bank loans.',
    icon: '/features/clock.svg',
  },
  {
    title: 'No Fixed EMIs',
    desc: 'Repayment adjusts with your sales. Pay more when business is good, less when it is slow.',
    icon: '/payments/upi-collections.svg',
  },
  {
    title: 'Build Credit History',
    desc: 'Timely repayments improve your credit score and unlock higher loan amounts in future.',
    icon: '/Developer-friendly/security-card.svg',
  },
  {
    title: 'Minimal Documentation',
    desc: 'Just basic KYC and UPI transaction history. No complex paperwork or financial statements.',
    icon: '/payments/payment-links.svg',
  },
  {
    title: 'Use for Any Purpose',
    desc: 'Inventory purchase, equipment upgrade, marketing, or working capital - your choice.',
    icon: '/business/msme.svg',
  },
  {
    title: '24/7 Support',
    desc: 'Dedicated support team available round the clock to help with any queries or issues.',
    icon: '/support.svg',
  },
]
      ...
      <Container>
        ...
        >
          ...
          <p className="fontbody2 text-gray-600 text-lg max-w-3xl mx-auto">
            Why thousands of businesses choose our Merchant Cash Advance
          </p>
        </motion.div>
