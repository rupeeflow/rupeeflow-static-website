      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-12">
        ...
        >
          ...
          <p className="fontbody2 text-lg text-gray-600 max-w-2xl mx-auto">
            Interactive dashboards that turn complex data into actionable
            insights
          </p>
        </motion.div>
              ...
              {collectionData.map((item, index) => (
                ...
                >
                  <div className="flex-1 w-full flex items-end">
                    ...
                    >
                      {/* Tooltip on hover */}
                      <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-white text-white text-xs px-2 py-1 rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
                        {item.label}
                      </div>
                    </motion.div>
                  </div>
