...
const stats = [
  { value: 2, suffix: '%', label: 'Savings from Discounts' },
  { value: 95, suffix: '%', label: 'Vendor Satisfaction' },
  { value: 50, suffix: '%', label: 'Faster Onboarding' },
  { value: 90, suffix: '%', label: 'Fewer Queries' },
];
      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-12">
        ...
        >
          ...
          <p className="fontbody2 text-lg text-gray-300 max-w-2xl mx-auto">
            Proven outcomes from businesses optimizing vendor relationships
          </p>
        </motion.div>
