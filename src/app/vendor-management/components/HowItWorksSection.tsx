...
import { UserPlus, FileText, BarChart3, TrendingDown, Handshake } from 'lucide-react';
...
const steps = [
  {
    ...
    description: 'Add vendors with digital forms and automated verification',
  },
  {
    icon: FileText,
    title: 'Set Payment Terms',
    description: 'Configure payment terms, discounts, and due date rules',
  },
  {
    icon: BarChart3,
    title: 'Track Performance',
    description: 'Monitor delivery times, quality, and reliability scores',
  },
  {
    icon: TrendingDown,
    title: 'Identify Discounts',
    description: 'Automatically spot early payment discount opportunities',
  },
  {
    icon: Handshake,
    title: 'Maintain Relationships',
    description: 'Build strong partnerships with timely payments and communication',
  },
];
      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-12">
        ...
        >
          ...
          <p className="fontbody2 text-lg text-gray-600 max-w-2xl mx-auto">
            Optimize vendor relationships in 5 simple steps
          </p>
        </motion.div>
        ...
        >
          <div className="w-full max-w-[800px] h-[320px] bg-gray-100 rounded-3xl flex items-center justify-center border-2 border-gray-200">
            <div className="text-center text-gray-400">
              ...
              <p className="text-xs">800x320 - Process Flow</p>
            </div>
          </div>
        </motion.div>
      </div>
