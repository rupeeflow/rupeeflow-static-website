      ...
      <div className="container mx-auto px-6 md:px-8 lg:px-12 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500/20 backdrop-blur-sm rounded-full mb-6">
            ...
            <span className="text-sm font-medium text-emerald-400">Build Better Relationships</span>
          </div>
          ...
          <p className="fontbody2 text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Capture discounts, improve satisfaction, and streamline vendor management
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-gray-400">
            {['Free trial', 'No credit card', 'Quick setup'].map((feature, index) => (
