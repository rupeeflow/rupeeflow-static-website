    ...
    <div className="w-full relative">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            >
              ...
              <p className="mt-6 text-gray-500 text-base md:text-lg fontbody2 leading-relaxed max-w-lg">
                ...
                a secure and streamlined process that offers full control and
              ...
              <div className="mt-8 flex flex-wrap gap-6">
                {[
                  ...
                  <div key={s.label}>
                    <p className="fontheading text-xl text-emerald-600">
                      {s.value}
                    </p>
              ...
              <div className="relative w-full max-w-[480px]">
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs fontheading text-gray-900">
                      GST Challan
                    </span>
                  </div>
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <p className="text-xs fontheading text-gray-900">
                      Payment Options
                    </p>
                    <div className="flex items-center gap-1.5">
                      <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center">
                        <span className="text-[8px] fontheading text-emerald-600">
                          ₹
                        </span>
                      </div>
                      <div>
                        <p className="text-[9px] text-gray-500 fontbody2">
                          Total Amount
                        </p>
                        <p className="text-xs fontheading text-gray-900">
                          ₹12,000
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      >
                        <span className="text-[6px] text-gray-500 fontbody2">
                          {m}
                        </span>
                      </div>
                    ))}
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="fontheading text-3xl md:text-4xl text-gray-900">
              How <span className="text-emerald-500">GST Payment</span> Works
              with Rupeeflow
            </h2>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="flex-1 space-y-8 w-full max-w-lg">
              {[
                {
                  n: '1',
                  title: 'Generate GST Challan',
                  desc: 'Create your GST challan directly from the Rupeeflow dashboard with pre-filled GSTIN details.',
                },
                {
                  n: '2',
                  title: 'Choose Payment Method',
                  desc: 'Pay via net banking, debit card, credit card, UPI, or NEFT/RTGS — whichever suits you best.',
                },
                {
                  n: '3',
                  title: 'Confirm & Pay',
                  desc: 'Review the challan details, verify the amount, and complete the payment securely.',
                },
              ].map(step => (
                <div key={step.n} className="flex items-start gap-5">
                  <div className="w-12 h-12 shrink-0 rounded-full border-2 border-emerald-500 flex items-center justify-center">
                    <span className="fontheading text-emerald-500 text-sm">
                      {step.n}
                    </span>
                  </div>
                  <div>
              ...
              <div className="flex items-start gap-5 bg-gray-50 rounded-2xl p-6 -ml-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1 fontbody2">
                    Receive an instant payment receipt with CIN number for your
                    records and GST portal update.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full max-w-[420px] bg-white rounded-2xl border border-gray-200 shadow-xl overflow-hidden">
                ...
                <div className="bg-emerald-600 px-6 py-5">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-emerald-200 text-[10px] fontbody2 uppercase tracking-wider">
                        GST Payment Receipt
                      </p>
                      <p className="text-white fontheading text-base mt-0.5">
                        Challan #GST-2026-0142
                      </p>
                    </div>
                ...
                <div className="px-6 py-5 space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-xs text-gray-500 fontbody2">
                      GSTIN
                    </span>
                    <span className="text-xs font-semibold text-gray-800 fontheading">
                      29AABCT1332L1ZD
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      >
                        ...
                        <p className="text-sm font-bold text-gray-900 mt-0.5 fontheading">
                          {tax.amount}
                        </p>
                      </div>
                    ))}
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-500 fontbody2">
                      Total Amount
                    </span>
                    <span className="text-lg font-bold text-emerald-600 fontheading">
                      ₹32,500
                    </span>
                  </div>
                  ...
                  <div className="bg-emerald-50 rounded-xl px-4 py-3 flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-bold text-gray-800 fontheading tracking-wide">
                        SBIN026070100012345
                      </p>
                    </div>
          ...
          <div className="space-y-24">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
              ...
              >
                ...
                <p className="text-sm md:text-base text-gray-500 fontbody2 leading-relaxed mb-6 max-w-xl">
                  Set up automated reminders and scheduled payments to ensure
                  your GST challans are always paid on time. Avoid late fees,
                  penalties, and interest charges with Rupeeflow&apos;s smart
              ...
              >
                <div className="w-full max-w-[380px] bg-white rounded-2xl border border-gray-200 shadow-lg p-6">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="text-sm fontheading text-gray-800">
                      February 2026
                    </h4>
                    <span className="text-[11px] bg-red-100 text-red-600 px-2.5 py-0.5 rounded-full font-semibold">
                      Due: Feb 20
                    </span>
                  </div>
                  {/* Day labels */}
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-3 bg-red-50 rounded-xl px-3 py-2.5">
                      ...
                      <div className="flex-1">
                        <p className="text-[11px] font-semibold text-gray-800 fontheading">
                          GST Filing Due
                        </p>
                        <p className="text-[10px] text-gray-500 fontbody2">
                          Feb 20 • GSTR-3B
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-10 lg:gap-16">
              ...
              >
                ...
                <p className="text-sm md:text-base text-gray-500 fontbody2 leading-relaxed mb-6 max-w-xl">
                  Pay your GST using credit cards, debit cards, net banking,
                  UPI, or NEFT/RTGS. Rupeeflow supports all major payment
                  methods so you can choose the most convenient option for your
                ...
                <div className="w-full max-w-[380px] bg-white rounded-2xl border border-gray-200 shadow-lg p-6">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-4">
                    {[
                      ...
                      <div
                        key={m.label}
                        className={`border rounded-xl p-3.5 flex flex-col gap-2 ${m.color}`}
                      >
                        <svg
                          className="w-5 h-5"
                          fill="none"
                  ...
                  <div className="bg-gray-50 rounded-xl px-4 py-3 flex items-center justify-between">
                    ...
                    <span className="text-base font-bold text-emerald-600 fontheading">
                      ₹48,500
                    </span>
                  </div>
                </div>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <h3 className="fontheading text-xl md:text-2xl text-gray-900">
                    Instant CIN Generation
                  </h3>
                </div>
                <p className="text-sm md:text-base text-gray-500 fontbody2 leading-relaxed mb-6 max-w-xl">
                  Get your Challan Identification Number (CIN) instantly after
                  successful payment. Download digital receipts and maintain a
                  complete audit trail for all your GST transactions directly
                  from the Rupeeflow dashboard.
                </p>
                {/* <Link href="#" className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full border-2 border-emerald-500 text-emerald-600 text-sm font-semibold hover:bg-emerald-50 transition-colors">
                  Get Started
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                <div className="w-full max-w-[380px] bg-white rounded-2xl border border-gray-200 shadow-lg overflow-hidden">
                  ...
                  <div className="bg-emerald-500 px-5 py-3 flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white font-bold text-sm fontheading">
                        Payment Successful
                      </p>
                      <p className="text-emerald-100 text-[10px] fontbody2">
                        Feb 26, 2026 · 11:42 AM
                      </p>
                    </div>
                  </div>
                  {/* CIN details */}
                  <div className="p-5 space-y-3">
                    <div className="bg-emerald-50 border border-emerald-200 rounded-xl px-4 py-3">
                      <p className="text-[10px] text-gray-500 fontbody2 mb-1">
                        Challan Identification Number (CIN)
                      </p>
                      <p className="text-sm font-bold text-gray-900 fontheading tracking-widest">
                        SBIN026070100012345
                      </p>
                    </div>
                    {[
                    ...
                    <button className="w-full mt-2 flex items-center justify-center gap-2 bg-white text-white text-xs font-semibold py-2.5 rounded-xl hover:bg-gray-800 transition-colors">
                      <svg
                        className="w-4 h-4"
                        fill="none"
                        viewBox="0 0 24 24"
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-10 lg:gap-16">
              ...
              >
                ...
                <p className="text-sm md:text-base text-gray-500 fontbody2 leading-relaxed mb-6 max-w-xl">
                  Every GST payment through Rupeeflow is protected with
                  bank-grade encryption and processed through RBI-authorized
                  payment channels. Your financial data stays secure with ISO
                  27001 compliance and multi-factor authentication.
                </p>
                {/* <Link href="#" className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full border-2 border-emerald-500 text-emerald-600 text-sm font-semibold hover:bg-emerald-50 transition-colors">
                  Get Started
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                <div className="w-full max-w-[380px] bg-white rounded-2xl border border-gray-200 shadow-lg p-6">
                  <div className="flex items-center gap-3 mb-5">
                    ...
                    <div>
                      <p className="text-sm fontheading text-gray-900">
                        Enterprise Security
                      </p>
                      <p className="text-[11px] text-gray-500 fontbody2">
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-4">
                    {[
                      ...
                      {
                        badge: '256-bit SSL',
                        level: 'End-to-End Encrypted',
                        color: 'bg-purple-50 border-purple-200',
                        badge_color: 'text-purple-700',
                      },
                      {
                        badge: 'ISO 27001',
                        level: 'Info Security Mgmt',
                        color: 'bg-orange-50 border-orange-200',
                        badge_color: 'text-orange-700',
                      },
                    ].map(c => (
                      <div
                        key={c.badge}
                        className={`border rounded-xl p-3 ${c.color}`}
                      >
                        <p
                          className={`text-xs font-bold fontheading ${c.badge_color}`}
                        >
                          {c.badge}
                        </p>
                        <p className="text-[10px] text-gray-500 fontbody2 mt-0.5">
                          {c.level}
                        </p>
                      </div>
                    ))}
      ...
      <section className="relative py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="fontheading text-3xl md:text-4xl text-gray-900">
              Rupeeflow <span className="text-emerald-500">Tax Payment</span>{' '}
              Features
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white border border-gray-200 rounded-2xl p-7 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-500 fontbody2 leading-relaxed">
                Generate GST challans with pre-filled GSTIN and tax details in
                seconds.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-7 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-500 fontbody2 leading-relaxed">
                Schedule recurring tax payments with automated reminders before
                due dates.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-7 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-500 fontbody2 leading-relaxed">
                Track all tax payments, view history, and download reports from
                one dashboard.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-7 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-500 fontbody2 leading-relaxed">
                256-bit encryption with ISO 27001 compliance for every tax
                transaction.
              </p>
            </div>
          </div>
